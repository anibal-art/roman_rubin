...
def fit_light_curve(file_name,algo):
    ...
    if not light_curve == 0:
        ...
        fit_2, e, tel_list = fit_rubin_roman(PARAMS['Source'],PARAMS,path_save,path_ephemerides,algo, array_w149, [], [], [], [], [], [])
        #fit_roman(PARAMS['Source'],PARAMS,path_save,path_ephemerides,algo, array_w149)
