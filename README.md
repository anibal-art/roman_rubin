...
![Equation](https://latex.codecogs.com/png.latex?cov_{kl}(y(\vec{x}))=\sum_i\sum_j\frac{\partial&space;y_k}{\partial&space;x_i}\frac{\partial&space;y_l}{\partial&space;x_j}cov(x_i,x_j))
