...
class BandpassDict(object):
    ...
    def load_bandpasses_from_files(
        ...
        filedir=os.path.join("/home/anibalvarela/troughputs/"),
        ...
        atmo_transmission="/home/anibalvarela/troughputs/"+ "atmos_std.dat",):
        """
    ...
    def load_total_bandpasses_from_files(
        cls,
        bandpass_names=["u", "g", "r", "i", "z", "y"],
        bandpass_dir=os.path.join("/home/anibalvarela/troughputs/"),
